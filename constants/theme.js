...
export const FONTS = {
    ...
    h3: { fontFamily: "RethinkSans-bold", fontSize: SIZES.h3, lineHeight: 22 },
    h4: { fontFamily: "RethinkSans-bold", fontSize: SIZES.h4, lineHeight: 22 },
    body1: { fontFamily: "Roboto-Regular", fontSize: SIZES.body1, lineHeight: 36 },
    body2: { fontFamily: "Roboto-Regular", fontSize: SIZES.body2, lineHeight: 30 },
    body3: { fontFamily: "RethinkSans-medium", fontSize: SIZES.body3, lineHeight: 22 },
    body4: { fontFamily: "RethinkSans-medium", fontSize: SIZES.body4, lineHeight: 22 },

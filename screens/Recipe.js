    ...
    function renderHeaderBar(){
        return(
            ...
            <Animated.View style={{
                ...
                <Text style={{color:COLORS.lightGray2,...FONTS.body4}}>Recipe By:</Text>
                <Text style={{color:COLORS.white2,...FONTS.body4}}>{selectedRecipe?.author?.name}</Text>
            </Animated.View>
                {/* back button */}
                <TouchableOpacity style={{
                    alignItems:'center',
    ...
    function renderRecipeDesc(){
        return(
            <View style={{
                ...
                <Text style={{...FONTS.body3}}>{selectedRecipe?.recipeInfo}</Text>
            </View>
        )
    }
  return (
